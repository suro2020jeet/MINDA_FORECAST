sap.ui.define([
	...
	"com/minda/Forecast/controller/BaseController",
	"sap/ui/model/Filter",
	...
	return Controller.extend("com.minda.Forecast.controller.Master", {
		formatter: formatter,
		onInit: function () {
			// debugger;
		...
		onAdvancedSearchPress: function () {
			if (!this._oDialog) {
				this._oDialog = sap.ui.xmlfragment("com.minda.Forecast.fragments.AdvancedSearch", this);
